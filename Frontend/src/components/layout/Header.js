...
const Header = () => {
  ...
  return (
    ...
    {/* logo */}
    <nav className='navbar row sticky-top'> {/* makes header sticy  */}
     ...
     <div className='col-12 col-md-3 mt-4 mt-md-0 text-center'> 
      ...
      {user ? (
        ...
        aria-labelledby='dropDownMenuButton'>
          ...
          to='/eats/orders/me/myOrders'>  Orders   
          </Link>
        ...
        !loading &&(<Link to='/users/login' className="btn ml-4" id='login_btn'> Login</Link>)
      )}
     </div>
    </nav>  
